...
var format_Circonscriptionsscolaires_9 = new ol.format.GeoJSON();
var features_Circonscriptionsscolaires_9 = format_Circonscriptionsscolaires_9.readFeatures(json_Circonscriptionsscolaires_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Circonscriptionsscolaires_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Circonscriptionsscolaires_9.addFeatures(features_Circonscriptionsscolaires_9);
var lyr_Circonscriptionsscolaires_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Circonscriptionsscolaires_9, 
                style: style_Circonscriptionsscolaires_9,
                popuplayertitle: 'Circonscriptions scolaires',
                interactive: true,
                title: '<img src="styles/legend/Circonscriptionsscolaires_9.png" /> Circonscriptions scolaires'
            });
var format_Circonscriptionslgislatives_10 = new ol.format.GeoJSON();
var features_Circonscriptionslgislatives_10 = format_Circonscriptionslgislatives_10.readFeatures(json_Circonscriptionslgislatives_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Circonscriptionslgislatives_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Circonscriptionslgislatives_10.addFeatures(features_Circonscriptionslgislatives_10);
var lyr_Circonscriptionslgislatives_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Circonscriptionslgislatives_10, 
                style: style_Circonscriptionslgislatives_10,
                popuplayertitle: 'Circonscriptions législatives',
                interactive: true,
                title: '<img src="styles/legend/Circonscriptionslgislatives_10.png" /> Circonscriptions législatives'
            });
var format_EPCIduDoubs_11 = new ol.format.GeoJSON();
var features_EPCIduDoubs_11 = format_EPCIduDoubs_11.readFeatures(json_EPCIduDoubs_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EPCIduDoubs_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EPCIduDoubs_11.addFeatures(features_EPCIduDoubs_11);
var lyr_EPCIduDoubs_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EPCIduDoubs_11, 
                style: style_EPCIduDoubs_11,
                popuplayertitle: 'EPCI du Doubs',
                interactive: true,
                title: '<img src="styles/legend/EPCIduDoubs_11.png" /> EPCI du Doubs'
            });
var format_Arrondissements_12 = new ol.format.GeoJSON();
var features_Arrondissements_12 = format_Arrondissements_12.readFeatures(json_Arrondissements_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Arrondissements_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Arrondissements_12.addFeatures(features_Arrondissements_12);
var lyr_Arrondissements_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Arrondissements_12, 
                style: style_Arrondissements_12,
                popuplayertitle: 'Arrondissements',
                interactive: true,
                title: '<img src="styles/legend/Arrondissements_12.png" /> Arrondissements'
            });
var format_Communes_13 = new ol.format.GeoJSON();
var features_Communes_13 = format_Communes_13.readFeatures(json_Communes_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Communes_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Communes_13.addFeatures(features_Communes_13);
var lyr_Communes_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Communes_13, 
                style: style_Communes_13,
                popuplayertitle: 'Communes',
                interactive: true,
                title: '<img src="styles/legend/Communes_13.png" /> Communes'
            });
var format_Doubs_14 = new ol.format.GeoJSON();
var features_Doubs_14 = format_Doubs_14.readFeatures(json_Doubs_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Doubs_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Doubs_14.addFeatures(features_Doubs_14);
var lyr_Doubs_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Doubs_14, 
                style: style_Doubs_14,
                popuplayertitle: 'Doubs',
                interactive: false,
                title: '<img src="styles/legend/Doubs_14.png" /> Doubs'
            });

lyr_PrimtredesTerritoiresEducatifsRuraux_0.setVisible(true);lyr_Primtredescitsducatives_1.setVisible(true);lyr_PrimtredesPEdT_2.setVisible(true);lyr_Comptencepriscolairesyndicale_3.setVisible(true);lyr_Comptencepriscolaireintercommunale_4.setVisible(true);lyr_Comptencepriscolairecommunale_5.setVisible(true);lyr_Comptencescolairesyndicale_6.setVisible(true);lyr_Comptencescolaireintercommunale_7.setVisible(true);lyr_Comptencescolairecommunale_8.setVisible(true);lyr_Circonscriptionsscolaires_9.setVisible(true);lyr_Circonscriptionslgislatives_10.setVisible(true);lyr_EPCIduDoubs_11.setVisible(true);lyr_Arrondissements_12.setVisible(true);lyr_Communes_13.setVisible(true);lyr_Doubs_14.setVisible(true);
var layersList = [lyr_PrimtredesTerritoiresEducatifsRuraux_0,lyr_Primtredescitsducatives_1,lyr_PrimtredesPEdT_2,lyr_Comptencepriscolairesyndicale_3,lyr_Comptencepriscolaireintercommunale_4,lyr_Comptencepriscolairecommunale_5,lyr_Comptencescolairesyndicale_6,lyr_Comptencescolaireintercommunale_7,lyr_Comptencescolairecommunale_8,lyr_Circonscriptionsscolaires_9,lyr_Circonscriptionslgislatives_10,lyr_EPCIduDoubs_11,lyr_Arrondissements_12,lyr_Communes_13,lyr_Doubs_14];
...
lyr_Circonscriptionsscolaires_9.set('fieldAliases', {'RCirco': 'RCirco', 'RTerritoir': 'RTerritoir', 'layer': 'layer', 'path': 'path', });
lyr_Circonscriptionslgislatives_10.set('fieldAliases', {'id_circo': 'id_circo', 'dep': 'dep', 'libelle': 'libelle', });
lyr_EPCIduDoubs_11.set('fieldAliases', {'fid': 'fid', 'code': 'code', 'nj_num': 'nj_num', 'nj_complet': 'nj_complet', 'intitule': 'intitule', });
lyr_Arrondissements_12.set('fieldAliases', {'fid': 'fid', 'code': 'code', 'libelle': 'libelle', });
lyr_Communes_13.set('fieldAliases', {'fid': 'fid', 'code': 'code', 'libelle': 'libelle', 'cheflieu': 'cheflieu', 'tncc': 'tncc', 'dct': 'dct', 'dar': 'dar', 'z20': 'z20', 'duu20': 'duu20', 'aav20': 'aav20', 'typo_aav20': 'typo_aav20', 'bv22': 'bv22', 'epc': 'epc', 'ctcd': 'ctcd', 'dep': 'dep', 'reg': 'reg', 'surf': 'surf', });
lyr_Doubs_14.set('fieldAliases', {'fid': 'fid', 'code': 'code', 'libelle': 'libelle', 'reg': 'reg', 'surf': 'surf', });
...
lyr_Circonscriptionsscolaires_9.set('fieldImages', {'RCirco': 'TextEdit', 'RTerritoir': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
lyr_Circonscriptionslgislatives_10.set('fieldImages', {'id_circo': 'TextEdit', 'dep': 'TextEdit', 'libelle': 'TextEdit', });
lyr_EPCIduDoubs_11.set('fieldImages', {'fid': 'TextEdit', 'code': 'TextEdit', 'nj_num': 'TextEdit', 'nj_complet': 'TextEdit', 'intitule': 'TextEdit', });
lyr_Arrondissements_12.set('fieldImages', {'fid': 'TextEdit', 'code': 'TextEdit', 'libelle': 'TextEdit', });
lyr_Communes_13.set('fieldImages', {'fid': 'TextEdit', 'code': 'TextEdit', 'libelle': 'TextEdit', 'cheflieu': 'TextEdit', 'tncc': 'TextEdit', 'dct': 'TextEdit', 'dar': 'TextEdit', 'z20': 'TextEdit', 'duu20': 'TextEdit', 'aav20': 'TextEdit', 'typo_aav20': 'TextEdit', 'bv22': 'TextEdit', 'epc': 'TextEdit', 'ctcd': 'TextEdit', 'dep': 'TextEdit', 'reg': 'TextEdit', 'surf': 'TextEdit', });
lyr_Doubs_14.set('fieldImages', {'fid': 'TextEdit', 'code': 'TextEdit', 'libelle': 'TextEdit', 'reg': 'TextEdit', 'surf': 'Range', });
...
lyr_Circonscriptionsscolaires_9.set('fieldLabels', {'RCirco': 'hidden field', 'RTerritoir': 'hidden field', 'layer': 'header label - always visible', 'path': 'hidden field', });
lyr_Circonscriptionslgislatives_10.set('fieldLabels', {'id_circo': 'hidden field', 'dep': 'hidden field', 'libelle': 'header label - always visible', });
lyr_EPCIduDoubs_11.set('fieldLabels', {'fid': 'hidden field', 'code': 'hidden field', 'nj_num': 'hidden field', 'nj_complet': 'hidden field', 'intitule': 'header label - always visible', });
lyr_Arrondissements_12.set('fieldLabels', {'fid': 'hidden field', 'code': 'hidden field', 'libelle': 'header label - always visible', });
lyr_Communes_13.set('fieldLabels', {'fid': 'hidden field', 'code': 'hidden field', 'libelle': 'header label - always visible', 'cheflieu': 'hidden field', 'tncc': 'hidden field', 'dct': 'hidden field', 'dar': 'hidden field', 'z20': 'hidden field', 'duu20': 'hidden field', 'aav20': 'hidden field', 'typo_aav20': 'hidden field', 'bv22': 'hidden field', 'epc': 'hidden field', 'ctcd': 'hidden field', 'dep': 'hidden field', 'reg': 'hidden field', 'surf': 'hidden field', });
lyr_Doubs_14.set('fieldLabels', {'fid': 'no label', 'code': 'no label', 'libelle': 'no label', 'reg': 'no label', 'surf': 'no label', });
lyr_Doubs_14.on('precompose', function(evt) {
